 ...
 * @author inesu
 */
public class DialogSubframe extends javax.swing.JFrame {

    /**
     * Creates new form DialogSubframe
     */
    public DialogSubframe() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogSubframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DialogSubframe().setVisible(true);
            }
        });
    }
